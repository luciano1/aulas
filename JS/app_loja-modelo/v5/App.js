...
export default function App() {
  ...
  async function salvarProdutos(products) {
      ...
      <View style={styles.content}>
        ...
        <View style={styles.formulario}>
          <Text style={styles.formTitulo}>
            {modoEdicao ? 'Editando Produto' : 'Novo Produto'}
          </Text>
          ...
          <Button
            title={modoEdicao ? 'Atualizar Produto' : 'Adicionar Produto'}
        ...
        {produtoSelecionado && (
          <View style={styles.selecionado}>
            <Text style={styles.destaqueTitulo}>Produto em edição:</Text>
            <Text>Nome: {produtoSelecionado.name}</Text>
            <Text>Preço: R$ {produtoSelecionado.price}</Text>
            <Text>Categoria: {produtoSelecionado.category}</Text>
            <Text>Estoque: {produtoSelecionado.quantity}</Text>
          </View>
        )}

        <ProductList products={products} selecionarProduto={editarProduto} />
      </View>
    </View>
  );
}
